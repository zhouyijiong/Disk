...
public class RSAUtils{
    ...
    public static String encryptByPublicKey(String data, RSAPublicKey publicKey)
        ...
        // 模长n转换成字节数
        BigInteger temp = publicKey.getModulus();
        int temp1 = temp.bitLength();
    ...
    
...
//        String encryptedMsg = rsa.getPK().encrypt(message);
//        rsa.getSK().decrypt(encryptedMsg);
...
//        // 使用公钥、私钥对象加解密
//        long InsertInterface = System.nanoTime();
//        List<Key> keyList = RSAUtils.getRSAKeyObject(2048);
//        String encryptedMsg = RSAUtils.encryptByPublicKey(message,(RSAPublicKey) keyList.get(0));
//        RSAUtils.decryptByPrivateKey(encryptedMsg,(RSAPrivateKey) keyList.get(1));
//        long b = System.nanoTime();
//        System.out.println(b - InsertInterface);
